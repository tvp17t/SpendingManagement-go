...
Xây dựng phần mềm quản lý chi tiêu cá nhân trên di động
...
### Danh sách các màn hình + demo <a name="screen"></a>
<p float="left">
...
## Hướng dẫn chạy <a name="run"></a>
Yêu cầu: cài [Go 1.22+](https://go.dev/dl/)

```bash
# clone repo
git clone https://github.com/<username>/SpendingManagement-go.git
cd SpendingManagement-go
...
```
SpendingManagement (Go skeleton) — replace with real logic.
```
